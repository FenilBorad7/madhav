		...
		<div class="content-wrapper">
			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					...
					<div class="cardbg">
						<form class="needs-validation" action="editproductprocess.php" novalidate enctype="multipart/form-data" method="post">
							<div class="form-row">
								<div class="col-md-12 mb-3">
                                      <input type="hidden" name="id" value="<?php echo $id;?>">

										<label>Blog Image:<span>*</span></label>
										<img src="upload/images<?php echo $row['image']; ?>" class="product-pic"></br>
										<input type="file" name="fileToUpload1"></br>
									</div>
									<div class="col-md-12 mb-3">
									<label for="validationCustom01">Blog name:</label>
									<input type="text" class="form-control" id="validationCustom01" name="pname" placeholder="Product name" value="<?php echo $row['title'];?>" >
									
								</div>
								<div class="col-md-12 mb-3">
									<label for="validationCustom02">Head Description:</label>
									<textarea type="textarea" class="form-control" id="validationCustom02" placeholder="Product description" name="hdescription"  rows="4" cols="50"><?php echo $row['h_description'];?></textarea>
									
										
								</div>
								<div class="col-md-12 mb-3">
									<label for="validationCustom02">Blog Description:</label>
									<!-- <textarea type="textarea" class="form-control" id="validationCustom02" placeholder="Product description" name="description"  rows="4" cols="50"><?php echo $row['h_description'];?></textarea> -->
									<textarea class="form-control" id="summernote" name="editordata"><?php echo $row['description'];?></textarea>
									<script>
